...
{
    /*
    to make leading zero we have to check which no help to become 10 so 2*5=10
    so we have to count min(count(2),count(5));
    ovious 5 count is minimum
    in 150 total 37 fives
    like no which contribute 
    one 5 -> 5 ,10, 15,20,25,30 ...150 all multiple of 5 total 30+
    two 5 -> 25 ,50,75,125,150 total 6 no
    three 5-> 125 total 1
    so sum=30+6+1=37
