...
void solve()
{
    /*
    Approach
    Same as exponention1
    if u using brute force then it takes n2 time
    but we can reduce it to nlogn
    power of any no can be calculate in logn 
    u just to twice the base and half the power till power become 0
    */
    ll n;
    cin >> n;
    ll m=1e9+7;
