...
/*
 Approach
 you have to subtract the case when they attack on each from the total no of case (nc2) where n=k*k;
 
 you obsereved in 2*3 rectangle and 3*2 there are two postion where they attack so count both type rectangle in the matrix and multiply
 by 2 to count total attacking postion
 */
