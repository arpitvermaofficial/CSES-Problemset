...
void solve()
{
    /*
    Approach
    We add each no and calculate the maximum sum upto that index and maximize the ans
    Case -1
    when prev + and no is +
    include in subarray
    case -2
    when prev is + and no is -
    no is incluede
    case -3
    when prev - no is +;
    old array is discard no is starting element of new array
    case -4
    when prev - no is -;
    old array is discard no is starting element of new array
    */
