...
void solve()
{
    /*
    Approach
    we have to allot a ticket whose cost diff to customer's price is minimum also the
    ticket price not be more than the customer's max price
    so we use lower bound
    */
    long long n, m;
    cin >> n >> m;
    set<pair<int, int>>s;
