...
void solve()
{
    /*
    Approach
    In this we sort array by minimum duration first
    intitutation for this is that those job who has longest deadline should be done at
    last as they have very large deadline
    and those have very short time duration should we done first as they finished earlier
    so contibute in more profit 
    */
    ll n;
    cin >> n;
    vector<pair<ll, ll>>v;
