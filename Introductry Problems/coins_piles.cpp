...
void solve()
{
    ...
    2 1 xtimes do
    1 2 y times do
    then a=2*x+y and b= 2*y+x
    so total a+b=3(x+y)
    --> (a+b)/3=(x+y)=total move . total move to be integer a+b must be divisible by 3
    2nd case --->
    larger no must be two times of smaller no as we take one coin from first pile and 2 from second pile and vica versa
    */
    long long a,b;
    cin >> a >> b;
