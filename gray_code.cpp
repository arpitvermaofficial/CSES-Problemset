...
void solve()
{
   /* 
    Approach 
    This q solved by recursion first we generate gray code for 1 lenght which be (0,1)
    in this we append 0 in begining so (00,01)
    then reverse 1 length gray code and append 1 in begining so (11 ,10) 
    and combination of above two is 2 bit gray code
